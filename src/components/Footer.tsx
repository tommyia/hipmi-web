        ...
        <div className="mx-auto max-w-7xl px-6 py-16 sm:py-24 lg:px-8 lg:py-32">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <div className="mt-8 flex justify-center">
              <Link
                ...
                className="bg-yellow-500 px-3.5 py-2.5 text-base font-semibold text-gray-900 shadow-sm hover:bg-yellow-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-yellow-400"
              >
                Daftar
              </Link>
            </div>
          ...
          <div className="mt-12 border-t border-white/10 pt-8 md:flex md:items-center md:justify-between">
            <div className="order-2 flex gap-x-6 md:order-3">
              <Link href="#" className="hidden text-gray-400 hover:text-gray-300">
                <span className="sr-only">Facebook</span>
                <svg className="size-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
                </svg>
              </Link>
              <Link href="https://www.instagram.com/hipmipemalang/" target="_blank" className="flex items-center space-x-1 text-gray-400 hover:text-gray-300">
            ...
            <p className="order-3 md:order-1 mt-8 text-sm/6 text-gray-400 md:mt-0">
              &copy; 2025 Himpi Pemalang. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
